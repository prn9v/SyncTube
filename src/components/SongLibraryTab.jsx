      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
        ...
        {selectedTracks.length > 0 && (
          <Button
            ...
            className="bg-spotify-green hover:bg-opacity-80 gap-2 w-full sm:w-auto"
          >
      ...
      <div className="bg-spotify-light rounded-lg overflow-hidden">
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 bg-spotify-dark rounded">
        ...
        <div className="block sm:hidden space-y-4 p-4">
          {filteredTracks.map((track, index) => (
            <div
              key={track.id}
              className="bg-spotify-dark rounded-lg p-4 space-y-2"
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    className="data-[state=checked]:bg-spotify-green data-[state=checked]:border-spotify-green"
                  />
                  <div className="h-10 w-10 bg-spotify-light rounded">
                    <Music className="h-6 w-6 m-2 text-spotify-offwhite" />
                  </div>
                  <div>
                ...
                <div className="text-sm text-right text-spotify-offwhite">
                  {track.duration}
                </div>
              </div>
